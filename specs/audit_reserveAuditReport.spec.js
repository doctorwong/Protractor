...
describe('The Reserve Audit Report', () => {
    var flyOutPO
    var auditPO
    var helperPage
    ...
    it('should be accessible from the flyout menu', async () => {
        ...
        helperPage.click(flyOutPO.selectReserveAudit);
        expect(browser.getCurrentUrl()).toEqual('http://' + browser.params.ENV + 'intraapps.ncci.com/rpf/#/reserve-audit');
    });
