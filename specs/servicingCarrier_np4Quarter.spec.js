...
describe('The NP4 Quarter to Quarter Comparison Report', () => {
    ...
    it('should have a selectable pool dropdown menu', async () => {
        ...
        browser.actions().sendKeys(protractor.Key.ENTER).perform()
        browser.actions().sendKeys(protractor.Key.TAB).perform()
        expect(reportPO.poolsDropdown.getAttribute('value')).toContain('08 - New Mexico WC Assigned Risk Pool');
    ...
    it('should be able to enter percentages and dollar amounts in older policy and recent policy year fields', async () => {
        browser.sleep(3000)
        helperPage.waitForVisibilityOf(reportPO.olderPolicyPercentInput)
        ...
        browser.sleep(3000)
        reportPO.olderPolicyPercentInput.sendKeys("11")
        ...
        browser.sleep(3000)
        helperPage.waitForVisibilityOf(reportPO.olderPolicyDollarInput)
        browser.actions().doubleClick(reportPO.olderPolicyDollarInput);
        browser.sleep(3000)
        browser.actions().sendKeys(protractor.Key.DELETE)
        //helperPage.clearElement(reportPO.getOlderPolicyDollarInputValue());
        reportPO.olderPolicyDollarInput.sendKeys("1111")
        //browser.clearElement(reportPO.olderPolicyDollarInput);
        browser.actions().sendKeys(protractor.Key.TAB).perform()
        browser.sleep(3000)
    ...
    it('should be to enter year in the corresponding field', async () => {
        browser.sleep(3000)
        helperPage.waitForVisibilityOf(reportPO.yearInput)
        browser.actions().doubleClick(reportPO.yearInput);
        browser.sleep(3000)
        browser.actions().sendKeys(protractor.Key.DELETE)
        //helperPage.clearElement(reportPO.getOlderPolicyDollarInputValue());
        reportPO.yearInput.sendKeys("2020")
        //browser.clearElement(reportPO.olderPolicyDollarInput);
        browser.actions().sendKeys(protractor.Key.TAB).perform()
        browser.sleep(3000)
